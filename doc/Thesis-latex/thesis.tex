...
\end{itemize}
Overall, while the Emulator is very fast in training and prediction, the main time consuming bottle-neck is getting the correct data and pre-processing it to fit the desired training setting.  
