\begin{table}[tbp]
    ...
    \end{tabular}
        \subcaption*{\small Table~\ref{tab:features}. Two and one-dimensional input features given to the model. Each feature is measured daily at (near) surface level. The frequency of variables is monthly through a monthly mean aggregation.}
            \label{tab:features}
\end{table}